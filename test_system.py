...
def test_chrome_profiles():
    """Chrome profil yönetimi test et"""
    print("\n🎭 Chrome Profil testleri...")
    ...
    try:
        ...
        print(f"✅ Bulunan profil sayısı: {len(profiles)}")
        
        if profiles:
            for profile in profiles[:2]:  # İlk 2 profili göster
...
def main():
    ...
    tests = [
        ...
        ("Chrome Profile Tests", test_chrome_profiles),
